...
import amber/deno/serve/serve_handler_info.{type ServeHandlerInfo}
import amber/deno/serve/serve_option.{type ServeOption}
import amber/web/promise.{type Promise}
import amber/web/request.{type Request}
import amber/web/response.{type Response}

@external(javascript, "./serve.ffi.ts", "HttpServer$")
pub type HttpServer
