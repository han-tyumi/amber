...
@external(javascript, "../amber__deno_ffi.mjs", "link_sync")
pub fn link_sync(oldpath: String, newpath: String) -> Result(Nil, Error)

@external(javascript, "../amber__deno_ffi.mjs", "open_sync")
pub fn open_sync(
  path: String,
  options: List(OpenOption),
) -> Result(FsFile, Error)

@external(javascript, "../amber__deno_ffi.mjs", "create_sync")
pub fn create_sync(path: String) -> Result(FsFile, Error)

@external(javascript, "../amber__deno_ffi.mjs", "mkdir_sync")
pub fn mkdir_sync(path: String, options: List(MkdirOption)) -> Nil

@external(javascript, "../amber__deno_ffi.mjs", "make_temp_dir_sync")
pub fn make_temp_dir_sync(options: List(MakeTempOption)) -> String

@external(javascript, "../amber__deno_ffi.mjs", "make_temp_file_sync")
pub fn make_temp_file_sync(options: List(MakeTempOption)) -> String

@external(javascript, "../amber__deno_ffi.mjs", "chmod_sync")
pub fn chmod_sync(path: String, mode: Int) -> Nil

@external(javascript, "../amber__deno_ffi.mjs", "chown_sync")
pub fn chown_sync(path: String, uid: Option(Int), gid: Option(Int)) -> Nil

@external(javascript, "../amber__deno_ffi.mjs", "remove_sync")
pub fn remove_sync(path: String, options: List(RemoveOption)) -> Nil

@external(javascript, "../amber__deno_ffi.mjs", "rename_sync")
pub fn rename_sync(oldpath: String, newpath: String) -> Nil

@external(javascript, "../amber__deno_ffi.mjs", "read_text_file_sync")
pub fn read_text_file_sync(path: String) -> String

@external(javascript, "../amber__deno_ffi.mjs", "read_file_sync")
pub fn read_file_sync(path: String) -> Uint8Array

@external(javascript, "../amber__deno_ffi.mjs", "real_path_sync")
pub fn real_path_sync(path: String) -> String

@external(javascript, "../amber__deno_ffi.mjs", "read_dir_sync")
pub fn read_dir_sync(path: String) -> List(DirEntry)

@external(javascript, "../amber__deno_ffi.mjs", "copy_file_sync")
pub fn copy_file_sync(from_path: String, to_path: String) -> Nil

@external(javascript, "../amber__deno_ffi.mjs", "read_link_sync")
pub fn read_link_sync(path: String) -> String

@external(javascript, "../amber__deno_ffi.mjs", "lstat_sync")
pub fn lstat_sync(path: String) -> FileInfo

@external(javascript, "../amber__deno_ffi.mjs", "stat_sync")
pub fn stat_sync(path: String) -> FileInfo

@external(javascript, "../amber__deno_ffi.mjs", "write_file_sync")
...
@external(javascript, "../amber__deno_ffi.mjs", "write_text_file_sync")
...
@external(javascript, "../amber__deno_ffi.mjs", "truncate_sync")
pub fn truncate_sync(name: String, len: Option(Int)) -> Nil

@external(javascript, "../amber__deno_ffi.mjs", "watch_fs")
pub fn watch_fs(paths: List(String), options: List(WatchFsOption)) -> FsWatcher

@external(javascript, "../amber__deno_ffi.mjs", "symlink_sync")
pub fn symlink_sync(
  oldpath: String,
  newpath: String,
...
@external(javascript, "../amber__deno_ffi.mjs", "utime_sync")
pub fn utime_sync(path: String, atime: Int, mtime: Int) -> Nil

@external(javascript, "../amber__deno_ffi.mjs", "umask")
pub fn umask() -> Int

@external(javascript, "../amber__deno_ffi.mjs", "set_umask")
