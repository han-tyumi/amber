...
@external(javascript, "../../amber__web__readable_stream.ffi.mjs", "locked")
pub fn locked(stream: ReadableStream(a)) -> Bool

@external(javascript, "../../amber__web__readable_stream.ffi.mjs", "cancel")
pub fn cancel(stream: ReadableStream(a), reason: r) -> Promise(Nil)

@external(javascript, "../../amber__web__readable_stream.ffi.mjs", "get_reader")
pub fn get_reader(stream: ReadableStream(a)) -> Reader(a)

@external(javascript, "../../amber__web__readable_stream.ffi.mjs", "get_byob_reader")
pub fn get_byob_reader(stream: ReadableStream(a)) -> ByobReader(a)

@external(javascript, "../../amber__web__readable_stream.ffi.mjs", "pipe_through")
pub fn pipe_through(
...
@external(javascript, "../../amber__web__readable_stream.ffi.mjs", "pipe_to")
pub fn pipe_to(
  stream: ReadableStream(a),
...
@external(javascript, "../../amber__web__readable_stream.ffi.mjs", "tee")
pub fn tee(stream: ReadableStream(a)) -> #(ReadableStream(a), ReadableStream(a))

@external(javascript, "../../amber__web__readable_stream.ffi.mjs", "async_iterator")
