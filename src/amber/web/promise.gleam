...
///
@external(javascript, "../../amber__web__promise_ffi.mjs", "new_")
...
///
@external(javascript, "../../amber__web__promise_ffi.mjs", "all")
...
///
@external(javascript, "../../amber__web__promise_ffi.mjs", "race")
pub fn race(values: List(Promise(a))) -> Promise(a)

/// Creates a new rejected promise for the provided reason.
///
@external(javascript, "../../amber__web__promise_ffi.mjs", "reject")
pub fn reject(reason: r) -> Promise(a)

/// Creates a new resolved promise for the provided value.
///
@external(javascript, "../../amber__web__promise_ffi.mjs", "resolve")
...
///
@external(javascript, "../../amber__web__promise_ffi.mjs", "any")
...
/// callback.
///
@external(javascript, "../../amber__web__promise_ffi.mjs", "finally_")
