...
@external(javascript, "../../amber__web__text_encoder.ffi.mjs", "new_")
pub fn new() -> TextEncoder

/// Turns a string into binary data (in the form of a Uint8Array) using UTF-8
/// encoding.
///
@external(javascript, "../../amber__web__text_encoder.ffi.mjs", "encode")
...
/// the encoding.
///
@external(javascript, "../../amber__web__text_encoder.ffi.mjs", "encode_into")
pub fn encode_into(
  encoder: TextEncoder,
  input: String,
  dest: Uint8Array,
