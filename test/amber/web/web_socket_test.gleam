...
import amber/deno/upgrade_web_socket_option
import amber/deno/web_socket_upgrade
import amber/web/abort_controller
import amber/web/binary_type
import amber/web/close_event
import amber/web/message_event
import amber/web/promise
import amber/web/web_socket
...
pub fn websocket_upgrade_with_options_test() {
  ...
  let server =
    serve.serve_with(
      ...
      fn(req, _info) {
        let web_socket_upgrade.WebSocketUpgrade(response:, socket:) =
          deno.upgrade_web_socket_with(req, [
